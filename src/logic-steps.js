...
if (core.isModLoaded('logic-steps')) {
  throw new Error(
    `[cc-alybox] Please uninstall the "Logic Steps" mod. Its functionality is included in this one, so it is now obselete. This mod is incompatible with it!`,
  );
}
